...
class RealtimeSimulator:
    def __init__(
        ...
        print(
            f"Real-time simulator initialized for {symbol} with {self.leverage}x leverage"
        )
    ...
    def calculate_indicators(self, df):
        ...
        return calculate_indicators(
            df, self.short_window, self.long_window, self.atr_period
        )
    ...
    def save_realtime_results(self):
        ...
        save_results(
            self.simulator, self.results_dir, self.symbol, self.initial_investment
        )
    ...
    def run_realtime_simulation(self, duration_hours=24, update_interval_minutes=15):
        ...
        return run_simulation(self, duration_hours, update_interval_minutes)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--symbol", type=str, default="BTCUSDT", help="Trading pair to simulate"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--leverage", type=int, default=5, help="Margin trading leverage (1-20x)"
    )
